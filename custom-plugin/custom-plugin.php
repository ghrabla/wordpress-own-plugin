...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'GHR', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/icon.png'));
    ...
    function custom_page_html_form() { ?>
        <div class="wrap">
            <h2>GHR Footer Plugin Setting</h2>
    ...
    function tryvary_include_inline_css()
{
    ...
    <style>
        .footer{
        background-color:black;color:white;display:flex;justify-content: space-between;align-items: center;padding:10px;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;
        }
        .footer-right{
